...
$(package)_patches=mac-qmake.conf aarch32-qmake.conf aarch64-qmake.conf fix-xcb-include-order.patch mingw-uuidof.patch pidlist_absolute.patch fix_qt_pkgconfig.patch fix_rcc_determinism.patch fix_riscv64_arch.patch
...
$(package)_config_opts += -no-iconv -no-kms -no-linuxfb -no-libudev -no-mitshm
